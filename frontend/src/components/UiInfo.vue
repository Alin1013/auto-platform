<template>
  <div class="ui-info-container">
    <!-- 背景图片 -->
    <div class="bg-image">
      <img src="@/assets/background.png" alt="UI测试详情背景" />
    </div>

    <!-- 页面标题 -->
    <h1 class="page-title">{{ currentProjectName }} - UI测试详情</h1>
...
export default {
  ...
  data() {
    return {
      functionItems: [
        { id: 'unit-test', name: '单元测试' },
        { id: 'business-test', name: '业务测试' },
        { id: 'test-report', name: '测试报告' },
        { id: 'test-case', name: '测试用例' },
        { id: 'log', name: '日志' },
        { id:'file',name:'录制文件'}
      ],
      activeSection: 'unit-test' // 默认激活单元测试
    }
  },
  methods: {
    // 返回首页
...
@media (max-width: 768px) {
  .ui-info-container {
    padding: 70px 10px 10px; /* 减少内边距，适配小屏幕 */
  }
  .page-title {
  ...
  .function-sidebar {
    padding: 12px; /* 减小功能栏内边距 */
  }
  .content-area {
    padding: 16px; /* 减小内容区内边距 */
  }
}
</style>